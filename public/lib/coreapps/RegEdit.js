        ...
        h("div", { id: "pane-right" },
            h("table", null,
                ...
                use(this.state.selected, (sel) => Object.entries(sel)
                    ...
                    h("input", { class: "value matter-textfield-outlined", "on:blur": function (event) {
                            const elements = event.srcElement.parentElement
                                .children;
                            try {
                                anura.settings.cache[elements[0].innerText] = JSON.parse(elements[2].value);
                                anura.settings.save();
                            }
                            catch (e) {
                                elements[2].value =
                                    anura.settings.cache[elements[0].innerText];
